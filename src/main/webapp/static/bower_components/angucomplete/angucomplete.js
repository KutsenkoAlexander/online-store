...
angular.module('angucomplete', [])
    ...
    .directive('angucomplete', function ($parse, $http, $sce, $timeout, $location, $rootScope, productByIdFactory) {
        return {
            restrict: 'EA',
            scope: {
                "id": "@id",
            ...
            link: function ($scope, elem, attrs) {
                ...
                $scope.selectResult = function (result) {
                    ...
                    $scope.results = [];
                    $scope.searchStr = null;
                    if($location.$$url === '/admin/goods'){
                        $rootScope.$broadcast('searched', {
                            fastEdit: false,
                            productSearched: productByIdFactory.query({id:result.originalObject.idProduct})
                        });
                    }else{
                        $location.path("/catalog/products/product/" + result.originalObject.idProduct);
                    }
                };
